...
exec apex_collection.update_member_attribute('EMP', p_seq => 1, p_attr_number => 2, p_attr_VALUE => 'KING THE GREATEST'); 
...
select * from v_emp;
call apex_util.set_session_state('P1_DEPTNO', '30'); -- you don't even need to create item
